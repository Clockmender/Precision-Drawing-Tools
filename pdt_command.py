...
def pdt_help(self, context):
    ...
    self.layout.label(text="C: Cursor (a, d, i, p)")
    self.layout.label(text="D: Duplicate Geometry (d, i)")
    self.layout.label(text="E: Extrude Geometry (d, i)")
    self.layout.label(text="F: Fillet (v, e)")
    self.layout.label(text="G: Grab (Move) (a, d, i, p)")
    self.layout.label(text="N: New Vertex (a, d, i, p)")
    self.layout.label(text="M: Maths Functions (x, y, z, d, a, p)")
    self.layout.label(text="P: Pivot Point (a, d, i, p)")
    self.layout.label(text="V: Extrude Vetice Only (a, d, i, p)")
    self.layout.label(text="S: Split Edges (a, d, i, p)")
    self.layout.label(text="?: Quick Help")
    self.layout.label(text="")
    self.layout.label(text="Secondary Letters:")
    self.layout.label(text="")
    self.layout.label(text="- General Options:")
    self.layout.label(text="a: Absolute (Global) Coordinates e.g. 1,3,2")
    self.layout.label(text="d: Delta (Relative) Coordinates, e.g. 0.5,0,1.2")
    self.layout.label(text="i: Directional (Polar) Coordinates e.g. 2.6,45")
    self.layout.label(text="p: Percent e.g. 67.5")
    self.layout.label(text="- Fillet Options:")
    self.layout.label(text="v: Fillet Vertices")
    self.layout.label(text="e: Fillet Edges")
    self.layout.label(text="- Math Options:")
    self.layout.label(text="x, y, z: Send result to X, Y and Z input fields in PDT Design")
    self.layout.label(text="d, a, p: Send result to Distance, Angle or Percent input field in PDT Design")
    self.layout.label(text="")
    self.layout.label(text="Note that commands are case-insensitive: ED = Ed = eD = ed")
    self.layout.label(text="")
    self.layout.label(text="Examples:")
    self.layout.label(text="")
    self.layout.label(text="ed0.5,,0.6")
    self.layout.label(text="'- Extrude Geometry Delta 0.5 in X, 0 in Y, 0.6 in Z")
    self.layout.label(text="")
    self.layout.label(text="fe0.1,4,0.5")
    self.layout.label(text="'- Fillet Edges")
    self.layout.label(text="'- Radius: 0.1 (float) -- the radius (or offset) of the bevel/fillet")
    self.layout.label(text="'- Segments: 4 (int) -- choosing an even amount of segments gives better geometry")
    self.layout.label(text="'- Profile: 0.5 (float[0.0;1.0]) -- 0.5 (default) yields a circular, convex shape")
